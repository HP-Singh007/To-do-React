    ...
    <div id='home'>
      <div id='addTask'>
        <form onSubmit={submitHandler}>
          <input id="title" type="text" placeholder='Title' value={title} onChange={(e)=>setTitle(e.target.value)} req/>
          <input id="desc" type="text" placeholder='Description' value={description} onChange={(e)=>setDesciption(e.target.value)}  req/>
          <button type='submit' disabled={creating}><PlusCircle color='white' /></button>
        </form>
      </div>
